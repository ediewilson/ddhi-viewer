...
var paths = {
	...
	copy: {
		input: source_dir + '/web-components/**/*', // default is copy-js/**/*
		output: build_dir + '/web-components'
	},
	reload: './'
};
...
var vendor_scripts = ['node_modules/ev-emitter/ev-emitter.js','node_modules/imagesloaded/imagesloaded.js','node_modules/jquery-reflow-table/dist/js/reflow-table.js','node_modules/slick-carousel/slick/slick.js','node_modules/in-view/dist/in-view.min.js'];
var vendor_styles = ['node_modules/jquery-reflow-table/dist/css/reflow-table.css','node_modules/slick-carousel/slick/slick.css'];
